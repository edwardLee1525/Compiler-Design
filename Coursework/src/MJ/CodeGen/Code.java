...
public class Code {
	...
	public static void assign(Operand x, Operand y) { // Generate an assignment x = y
		load(y);
		switch(x.kind){
			case Operand.Con:
				Parser.error("cannot assign a const");
				break;
			case Operand.Static:
			...
			case Operand.Elem:
				...
				break;
			case Operand.Stack: break;
			default: Parser.error("cannot assign this value");
		}
	}
